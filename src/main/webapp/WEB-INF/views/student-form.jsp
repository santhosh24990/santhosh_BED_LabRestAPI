...
<body>
  <div class="container p-3 my-3 bg-primary text-white">
    <h2 style="text-align:center;">college fest</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <form action="save" method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Enter firstname" name="first_name" value="${student.first_name}">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Enter lastname" name="last_name" value="${student.last_name}">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Enter course" name="course" value="${student.course}">
            </div>
            <div class="form-group">
